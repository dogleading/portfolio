  ...
  return (
    <ToastPrimitives.Root
      ...
      className={cn(
        ...
        variant === "destructive" &&
          "destructive border-red-500/50 text-red-600 dark:border-red-900/50 dark:text-red-50 [&>svg]:text-red-600 dark:[&>svg]:text-red-50",
...
const ToastAction = React.forwardRef(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      "inline-flex h-8 shrink-0 items-center justify-center rounded-md border border-border bg-transparent px-3 text-sm font-medium ring-offset-background transition-colors hover:bg-secondary focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 group-[.destructive]:border-red-500/50 group-[.destructive]:hover:border-red-600/50 group-[.destructive]:hover:bg-red-600 group-[.destructive]:hover:text-red-50 group-[.destructive]:focus:ring-red-600",
      className
    )}
    {...props}
  />
...
const ToastClose = React.forwardRef(({ className, ...props }, ref) => (
  ...
  >
    ...
    >
      <path d="m21 21-6-6m0 0L9 9m6 6 6-6M15 15 9 21" />
    </svg>
  </ToastPrimitives.Close>
));
